...
const tutorialSteps: TutorialStep[] = [
  {
    id: 1,
    title: "Bem-vindo ao NotaUp!",
    content: "Este é um guia rápido para ajudá-lo a entender como usar o sistema de gerenciamento de tarefas. O NotaUp é uma plataforma completa para gerenciar projetos, tarefas e equipes de trabalho."
  },
  {
    id: 2,
